...
```
.gemini/
  prompts.yaml          # Gemini Code Assist用のプロンプト設定
.github/
  workflows/
...
Gemini Code Assistに記事のスパム判定と形式検証を実行させるためのプロンプト設定です。
...
A: コメントに表示された問題点を修正し、PRを更新してください。再度自動検証が実行されます。
